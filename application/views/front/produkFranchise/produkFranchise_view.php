		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					...
					<h1 class="mb-0 bread">Daftar Produk Franchise</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-lg-10 order-md-last">
					<div class="row">
						<?php
						foreach ($produkfranchise as $data) {
						?>
							<div class="col-sm-6 col-md-6 col-lg-4 ftco-animate">
								<div class="product">
									...
									<div class="text py-3 px-3">
										<h3><a href="#"><?php echo $data->nama_franchise ?></a></h3>
										<div class="d-flex">
											<div class="pricing">
												<p class="price"><span><?php echo $data->harga ?></span></p>
											</div>
											<div class="rating">
												<p class="text-right">
