<head>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url('asset/template/admin/bower_components') ?>/jvectormap/jquery-jvectormap.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url('asset/template/admin') ?>/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo base_url('asset/template/admin') ?>/dist/css/skins/_all-skins.min.css">
