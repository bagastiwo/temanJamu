        ...
        <section class="content">
            ...
            <ul class="breadcrumb">
                <li><a href="<?php echo base_url('admin/barang/insert') ?>"><i class="fa fa-plus"></i>Tambah Data</a></li>
            </ul>
                                ...
                                <tbody>
                                    ...
                                    foreach ($barang as $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo base_url('admin/barang/edit/' . $data->id_barang); ?>">
                                                    <button type="button" class="btn btn-primary btn-xs">Edit</button></a>
                                            </td>
                                            <td align="center">
                                                <a href="<?php echo base_url('admin/barang/delete/' . $data->id_barang); ?>">
